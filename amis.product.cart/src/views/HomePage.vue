          ...
          <div className="main-slider slider slick-initialized slick-slider">
            <div id="carouselExampleIndicators" class="carousel slide" data-ride="carousel" data-interval="3000">
                ...
                <div class="carousel-inner">
                    ...
                    <img class="d-block w-100" src="../assets/images/image2.webp" alt="First slide">
                    </div>
                    <div class="carousel-item">
                    <img class="d-block w-100" src="../assets/images/image1.webp" alt="Second slide">
                    </div>
                    <div class="carousel-item">
                    <img class="d-block w-100" src="../assets/images/image3.webp" alt="Third slide">
                    </div>
                </div>
